    ...
    <section className="pt-4 lg:pt-6">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
          ...
          >
            <p className="text-[9px] font-bold uppercase tracking-[0.4em] text-[#E94368] mb-4 font-ui">Global Holiday Intelligence</p>
            <h1 className="text-5xl md:text-6xl lg:text-[72px] font-bold leading-[0.9] mb-6 tracking-[-0.04em] text-[#17151A] font-display">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-start gap-8">
              <Button size="lg" className="btn-ink h-11 px-8 text-[9px] font-bold uppercase tracking-[0.3em] rounded-sm transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg shadow-[#17151A]/10">
          ...
          <motion.div 
            ...
            className="flex-1 w-full max-w-md lg:sticky lg:top-16"
          >
