...
export function TrustInfrastructure() {
  ...
  return (
    <section id="intelligence" className="container mx-auto px-6 py-24">
      <div className="bg-[#17151A] text-[#F7F4EE] p-12 md:p-24 rounded-sm relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-24">
            <div className="max-w-3xl space-y-6">
                <p className="text-[10px] font-bold uppercase tracking-[0.5em] text-[#E94368] font-ui text-left">Infrastructure</p>
                <h2 className="text-4xl md:text-7xl font-bold font-display leading-[0.95] tracking-tighter text-left">Trust is part <br/>of the data.</h2>
                <p className="text-lg md:text-xl text-[#F7F4EE]/60 font-ui leading-relaxed max-w-2xl text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
                {pillars.map(p => (
                    <div key={p.title} className="space-y-4">
                        ...
                        <h4 className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#E94368] font-ui text-left">{p.title}</h4>
                        <p className="text-sm leading-relaxed text-[#F7F4EE]/80 font-ui font-medium text-left">{p.desc}</p>
                    </div>
                ))}
            </div>
        </div>
