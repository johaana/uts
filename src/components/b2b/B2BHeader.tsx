...
export function B2BHeader() {
  return (
    <header className="b2b-header h-[72px] border-b border-[#DED9D0]/60 bg-[#F7F4EE]/90 backdrop-blur-md sticky top-0 z-50">
      <div className="container mx-auto h-full flex items-center justify-between px-6">
        ...
        <nav className="hidden md:flex items-center gap-10">
          <Link href="#product" className="text-[11px] font-bold text-[#6D6870] hover:text-[#17151A] transition-all uppercase tracking-[0.2em] font-ui">Product</Link>
          <Link href="#data" className="text-[11px] font-bold text-[#6D6870] hover:text-[#17151A] transition-all uppercase tracking-[0.2em] font-ui">Data</Link>
          <Link href="#developers" className="text-[11px] font-bold text-[#6D6870] hover:text-[#17151A] transition-all uppercase tracking-[0.2em] font-ui">Developers</Link>
        </nav>
