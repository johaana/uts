...
export function GHIWorldPulseSection() {
  const regions = [
  ...
  return (
    <section className="container mx-auto px-6 py-24">
      <div className="mb-20 text-center space-y-4">
        ...
        <p className="text-lg text-[#6D6870] font-ui max-w-xl mx-auto font-medium">A living view of holidays and observances happening now and next.</p>
      </div>
