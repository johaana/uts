...
export const allFestivals = [
    ...
    { name: "Parsi New Year (Navroz)", region: "Nationwide", description: "The Parsi day of repentance (Pateti), followed by Navroz, the joyous New Year celebration.", link: "/festivals/parsi-new-year", image: "https://i.postimg.cc/bwD0xd8T/navroz1.webp", hint: "parsi celebration" },
