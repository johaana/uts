...
export const allFestivals = [
    ...
    { name: "Vasant Panchami", region: "Nationwide", description: "A festival that marks the preparation for the arrival of spring, dedicated to the goddess Saraswati.", link: "/festivals/vasant-panchami", image: "https://i.postimg.cc/zBPz6ms6/Vasant-Panchami1.avif", hint: "saraswati puja" },
    ...
    { name: "Mopin", region: "Northeast", description: "A vibrant harvest festival of the Galo tribe in Arunachal Pradesh to drive away evil spirits.", link: "/festivals/mopin", image: "https://i.postimg.cc/VkcY3Whf/Mopin.webp", hint: "galo tribe" },
