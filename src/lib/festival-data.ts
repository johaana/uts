...
export const internationalFestivals = [
    { name: "Chinese New Year", region: "China", description: "The vibrant 15-day celebration of the lunar new year, filled with dragon dances, red lanterns, and feasting.", link: "/festivals/chinese-new-year", image: "https://i.postimg.cc/Pq9v7Zt2/chinese-new-year.jpg", hint: "dragon dance" },
    { name: "Cherry Blossom Festival (Hanami)", region: "Japan", description: "Japan's serene festival celebrating the transient beauty of cherry blossoms with picnics under the sakura trees.", link: "/festivals/cherry-blossom-festival", image: "https://i.postimg.cc/T3sT8JgC/cherry-blossom-festival-japan.jpg", hint: "cherry blossoms" },
    { name: "Dia de los Muertos", region: "Mexico", description: "A colorful Mexican holiday honoring deceased loved ones with altars, sugar skulls, and marigolds.", link: "/festivals/dia-de-los-muertos", image: "https://i.postimg.cc/tJnzyzKz/dia-de-los-muertos.jpg", hint: "day of the dead" },
    { name: "Carnival", region: "Brazil", description: "The world's most famous street party in Rio, with dazzling samba parades, elaborate costumes, and non-stop music.", link: "/festivals/carnival", image: "https://i.postimg.cc/DwnTfc1z/carnival.jpg", hint: "brazil carnival" },
    { name: "Thanksgiving", region: "USA", description: "A day for gratitude, feasting on turkey, and family gatherings to give thanks for the harvest's blessings.", link: "/festivals/thanksgiving", image: "https://i.postimg.cc/t4yW8v8k/thanksgiving.jpg", hint: "thanksgiving dinner" },
    { name: "Halloween", region: "USA & Global", description: "A spooky celebration with costumes, trick-or-treating, and jack-o'-lanterns, rooted in ancient Celtic traditions.", link: "/festivals/halloween", image: "https://i.postimg.cc/wMPbVjwZ/halloween.jpg", hint: "jack-o-lantern" },
    { name: "Songkran", region: "Thailand", description: "Thailand's wild and joyous New Year celebration, famous for its nationwide water fights symbolizing purification.", link: "/festivals/songkran", image: "https://i.postimg.cc/5Nc7pGdk/songkran-water-festival.jpg", hint: "water festival" },
