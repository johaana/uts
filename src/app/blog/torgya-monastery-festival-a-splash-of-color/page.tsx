...
export default function SingleBlogPage() {
    const title = "Torgya: The Masked Dances of Tawang Monastery";
    return (
        <div className="container mx-auto px-4 py-12">
            <Card className="overflow-hidden">
                <CardContent className="p-0 md:p-6 md:p-10">
                     <div className="md:hidden relative h-64 w-full mb-8">
                        <Image src="https://i.postimg.cc/Cxn6kcwy/torgya-2.jpg" alt="Torgya Festival" layout="fill" objectFit="cover" data-ai-hint="tawang monastery" />
                    </div>
                    ...
                    <article className="prose max-w-none text-foreground/80 p-6 pt-0 md:p-0">
                         ...
                         <div className="hidden md:block relative h-96 w-full mb-8">
                            <Image src="https://i.postimg.cc/Cxn6kcwy/torgya-2.jpg" alt="Torgya Festival" layout="fill" objectFit="contain" data-ai-hint="tawang monastery" className="rounded-lg"/>
                        </div>
