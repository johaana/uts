                ...
                <CardContent className="p-6 md:p-10">
                    ...
                    <article className="prose max-w-none text-foreground/80">
                         ...
                         <div className="relative h-96 w-full mb-8">
                            <Image src="https://i.postimg.cc/kgQyP7Ym/makar-sankranti1.webp" alt="Planning calendar for 2025" layout="fill" objectFit="contain" data-ai-hint="holiday planning calendar" className="rounded-lg"/>
                        </div>
