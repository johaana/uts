            ...
            <Card className="overflow-hidden md:-mt-16 relative z-10 md:rounded-t-2xl">
                <CardContent className="p-6 md:p-10">
                    ...
                    <article className="prose max-w-none text-foreground/80">
                        ...
                        <p><strong>Eastern India (Bengal):</strong> For Bengalis, Diwali night often becomes Kali Puja, a fierce, ecstatic worship of the goddess Kali rather than the gentle Lakshmi imagery common elsewhere.</p>
