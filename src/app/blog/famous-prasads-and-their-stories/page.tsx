            ...
            <Card className="overflow-hidden md:-mt-16 relative z-10 md:rounded-t-2xl">
                <CardContent className="p-6 md:p-10">
                    ...
                    <article className="prose max-w-none text-foreground/80">
                        ...
                        <p>**The Unique Tradition:** It is prepared with continuous chanting of Gurbani (Sikh hymns), which is believed to infuse the prasad with spiritual vibrations. The prasad is served to every single visitor, regardless of their faith or background, embodying the core Sikh principles of selfless service ('seva') and the oneness of humanity. It is served in cupped hands as a gesture of humility and respect.</p>
                        ...
                        <p>**The Unique Tradition:** The tradition is rooted in Krishna's legendary love for milk and butter. The pedas are a sweet offering reminiscent of his divine leelas (pastimes) in the Braj region. The unique brown color comes from roasting the khoya for a long time on a low flame, a process that requires great skill and patience.</p>
