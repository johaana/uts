            ...
            <Card className="overflow-hidden">
                <CardContent className="p-0 md:p-6 md:p-10">
                     <div className="md:hidden relative h-64 w-full mb-8">
                        <Image src="https://i.postimg.cc/j28kQ9WT/thrissur-puram-festival-2.jpg" alt="Thrissur Pooram" layout="fill" objectFit="cover" data-ai-hint="kerala temple festival" />
                    </div>
