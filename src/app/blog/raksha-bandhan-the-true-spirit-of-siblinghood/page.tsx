            ...
            <Card className="overflow-hidden">
                <CardContent className="p-0 md:p-6 md:p-10">
                     <div className="md:hidden relative h-64 w-full mb-8">
                        <Image src="https://i.postimg.cc/9MXxXQhY/Raksha-Bandhan.jpg" alt="A sister tying a rakhi on her brother's wrist" layout="fill" objectFit="cover" data-ai-hint="rakhi thread" />
                    </div>
