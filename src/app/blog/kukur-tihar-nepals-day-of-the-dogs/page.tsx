            ...
            <Card className="overflow-hidden md:-mt-16 relative z-10 md:rounded-t-2xl">
                <CardContent className="p-6 md:p-10">
                    ...
                    <article className="prose max-w-none text-foreground/80">
                        ...
                        <ul>
                            <li><strong>Mala (Flower Garlands):</strong> The first order of the day is to adorn every dog with a beautiful garland of marigold flowers. In Hindu tradition, marigolds are considered auspicious and are often used in worship. Placing a 'mala' on the dog is a mark of respect and dignity, signifying the sacredness of the animal being worshipped.</li>
                            <li><strong>Tika (Vermillion Mark):</strong> A red tika (a paste made from abir powder, rice, and yogurt) is applied to the dog's forehead. This mark is a powerful blessing and a symbol of their divine role on this special day, wishing them good health and acknowledging them as devotees of the divine.</li>
                        ...
                        <div className="flex justify-center my-8">
                           <Image src="https://i.postimg.cc/tTwx8B4m/kukurtihar.webp" alt="A dog with a marigold garland and tika" width={500} height={350} className="rounded-lg shadow-lg" data-ai-hint="dog with garland"/>
                        </div>
