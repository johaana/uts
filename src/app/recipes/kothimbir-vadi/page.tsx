                ...
                <CardHeader className="p-6 md:p-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="md:w-1/3">
                           <Image src="https://i.postimg.cc/fRZtG4XW/Sweets1.jpg" alt="Kothimbir Vadi" width={400} height={250} className="rounded-lg shadow-lg" data-ai-hint="coriander fritters"/>
                        </div>
                    </div>
                </CardHeader>
