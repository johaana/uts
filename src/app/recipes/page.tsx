...
const recipes = [
    ...
    { name: "Thandai", festival: "Holi", region: "North", description: "A cold drink prepared with a mixture of almonds, fennel seeds, and other spices.", link: "/recipes/thandai", image: "https://i.postimg.cc/sanin-sn-B4-ZQ2m-KEiq-Y-unsplash.jpg", hint: "holi drink" },
