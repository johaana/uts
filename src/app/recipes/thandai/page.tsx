        ...
        <div className="container mx-auto px-4 py-12">
            <Card>
                ...
                <CardContent className="p-6 md:p-10">
                    ...
                    <p className="text-lg text-muted-foreground mb-6">The official drink of Holi, Thandai is a refreshing and aromatic cold beverage made with a blend of nuts, seeds, and spices, perfect for cooling down during the colorful festivities.</p>
