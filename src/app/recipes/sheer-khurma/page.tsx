        ...
        <div className="container mx-auto px-4 py-12">
            <Card>
                <CardHeader className="p-0">
                     <Image src="https://i.postimg.cc/94TmvFCj/Eid3.jpg" alt="Sheer Khurma" width={1200} height={600} className="w-full h-auto object-cover rounded-t-lg" data-ai-hint="vermicelli pudding" />
                </CardHeader>
