        ...
        <div className="container mx-auto px-4 py-12">
            <Card>
                <CardHeader className="p-0">
                     <Image src="https://images.unsplash.com/photo-1620428268459-2f27918c5c79?q=80&w=1200&h=600&fit=crop" alt="Sheer Khurma" width={1200} height={600} className="w-full h-auto object-cover rounded-t-lg" data-ai-hint="vermicelli pudding" />
                </CardHeader>
