        ...
        <div className="container mx-auto px-4 py-12">
            <Card>
                <CardHeader className="p-0">
                     <Image src="https://images.unsplash.com/photo-1625391029258-a53655383921?q=80&w=1200&h=600&fit=crop" alt="Sheer Khurma" width={1200} height={600} className="w-full h-auto object-cover rounded-t-lg" data-ai-hint="vermicelli pudding" />
                </CardHeader>
                <CardContent className="p-6 md:p-10">
                    <CardTitle className="font-headline text-4xl mb-4">Sheer Khurma</CardTitle>
                    <p className="text-lg text-muted-foreground mb-6">A rich and creamy vermicelli pudding made with milk, dates, nuts, and aromatic spices. It's the quintessential dessert for Eid-al-Fitr celebrations.</p>
