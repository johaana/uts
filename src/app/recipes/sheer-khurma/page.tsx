                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        <div className="md:w-2/3">
                         ...
                         <div className="md:w-1/3">
                           <Image src="https://i.postimg.cc/d1LHYzTj/sheer-khurma.jpg" alt="Sheer Khurma" width={400} height={250} className="rounded-lg shadow-lg" data-ai-hint="vermicelli pudding"/>
                        </div>
                    </div>
                </CardHeader>
