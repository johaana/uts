        ...
        <div className="container mx-auto px-4 py-12">
            <Card>
                <CardHeader className="p-0">
                     <Image src="https://images.unsplash.com/photo-1625391029258-a53655383921?q=80&w=1200&h=600&fit=crop" alt="Puran Poli" width={1200} height={600} className="w-full h-auto object-cover rounded-t-lg" data-ai-hint="sweet flatbread" />
                </CardHeader>
