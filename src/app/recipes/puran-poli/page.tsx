        ...
        <div className="container mx-auto px-4 py-12">
            <Card>
                <CardHeader className="p-0">
                     <Image src="https://images.unsplash.com/photo-1610398285863-1620d8a4a4c4?q=80&w=1200&h=600&fit=crop" alt="Puran Poli" width={1200} height={600} className="w-full h-auto object-cover rounded-t-lg" data-ai-hint="sweet flatbread" />
                </CardHeader>
                <CardContent className="p-6 md:p-10">
                    <CardTitle className="font-headline text-4xl mb-4">Puran Poli</CardTitle>
                    <p className="text-lg text-muted-foreground mb-6">A quintessential Maharashtrian sweet flatbread, Puran Poli is specially made during festivals like Ganesh Chaturthi and Holi.</p>
