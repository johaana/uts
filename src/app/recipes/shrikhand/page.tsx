        ...
        <div className="container mx-auto px-4 py-12">
            <Card>
                <CardHeader className="p-6 md:p-10">
                    <CardTitle className="font-headline text-4xl mb-4">Shrikhand</CardTitle>
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="md:w-1/3">
                           <Image src="https://i.postimg.cc/fRZtG4XW/Sweets1.jpg" alt="Shrikhand" width={400} height={250} className="rounded-lg shadow-lg" data-ai-hint="yogurt dessert"/>
                        </div>
                    </div>
                </CardHeader>
