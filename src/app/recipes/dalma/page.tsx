                ...
                <CardHeader className="p-6 md:p-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="md:w-1/3">
                           <Image src="https://i.postimg.cc/YSpNpMyJ/sudarshan-poojary-FZw-Bem-Sc-Rc0-unsplash.jpg" alt="Dalma" width={400} height={250} className="rounded-lg shadow-lg" data-ai-hint="lentil stew"/>
                        </div>
                    </div>
                </CardHeader>
