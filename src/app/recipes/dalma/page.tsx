        ...
        <div className="container mx-auto px-4 py-12">
            <Card>
                 <CardHeader className="p-6 md:p-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="md:w-1/3">
                            <Image src="https://i.postimg.cc/1XjZgd9K/Dalma-jpg.webp" alt="Dalma" width={400} height={250} className="rounded-lg shadow-lg" data-ai-hint="lentil stew" />
                        </div>
                    </div>
                </CardHeader>
                <CardContent className="p-6 md:p-10 pt-0">
                    ...
                    <ShareButtons title="Dalma Recipe" />
                </CardContent>
            </Card>
        </div>
    );
