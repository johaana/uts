...
const festivals = [
    { name: "Diwali", region: "Nationwide", image: "https://images.unsplash.com/photo-1542882583-93e9a1a8e83c?q=80&w=600&h=400&fit=crop", hint: "lights diyas", description: "The festival of lights, symbolizing the victory of light over darkness and good over evil.", link: "/festivals/diwali" },
    { name: "Holi", region: "Nationwide", image: "https://images.unsplash.com/photo-1519794206461-cc6881b85528?q=80&w=600&h=400&fit=crop", hint: "colors powder", description: "The vibrant festival of colors, celebrating the arrival of spring, love, and the triumph of good.", link: "/festivals/holi" },
    { name: "Eid-al-Fitr", region: "Nationwide", image: "https://images.unsplash.com/photo-1588062803975-7c9181244955?q=80&w=600&h=400&fit=crop", hint: "eid prayer celebration", description: "Marking the end of Ramadan, this festival is a joyous celebration of feasting, prayer, and charity.", link: "/festivals/eid-al-fitr" },
    ...
    { name: "Ganesh Chaturthi", region: "West & South", image: "https://images.unsplash.com/photo-1604213410393-8e4342838753?q=80&w=600&h=400&fit=crop", hint: "ganesha idol", description: "A spectacular festival celebrating the birth of Lord Ganesha, the god of new beginnings and wisdom.", link: "/festivals/ganesh-chaturthi" },
    { name: "Christmas", region: "Nationwide", image: "https://images.unsplash.com/photo-1512151121226-c56182a4413e?q=80&w=600&h=400&fit=crop", hint: "christmas tree", description: "Celebrating the birth of Jesus Christ, marked by carols, feasts, and the spirit of giving.", link: "/festivals/christmas" },
    ...
    { name: "Onam", region: "South", image: "https://images.unsplash.com/photo-1601664118464-58f278f79e27?q=80&w=600&h=400&fit=crop", hint: "flower carpet", description: "Kerala's most important harvest festival, celebrating the homecoming of the mythical King Mahabali.", link: "/festivals/onam" },
    ...
    { name: "Raksha Bandhan", region: "Nationwide", image: "https://images.unsplash.com/photo-1597753258833-66881a535496?q=80&w=600&h=400&fit=crop", hint: "sacred thread", description: "A festival that celebrates the cherished bond between brothers and sisters, marked by the tying of a sacred thread.", link: "/festivals/raksha-bandhan" },
