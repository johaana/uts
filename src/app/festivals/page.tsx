...
const festivals = [
    { name: "Diwali", region: "Nationwide", image: "https://i.postimg.cc/Wt73N3rN/Diwali2.jpg", hint: "lights diyas", description: "The festival of lights, symbolizing the victory of light over darkness and good over evil.", link: "/festivals/diwali" },
    { name: "Holi", region: "Nationwide", image: "https://i.postimg.cc/mzjssPnK/holi.jpg", hint: "colors powder", description: "The vibrant festival of colors, celebrating the arrival of spring, love, and the triumph of good.", link: "/festivals/holi" },
    { name: "Eid-al-Fitr", region: "Nationwide", image: "https://i.postimg.cc/CBghYTxn/Eid2.jpg", hint: "eid prayer celebration", description: "Marking the end of Ramadan, this festival is a joyous celebration of feasting, prayer, and charity.", link: "/festivals/eid-al-fitr" },
    ...
    { name: "Ganesh Chaturthi", region: "West & South", image: "https://i.postimg.cc/Vrm8pqKj/ganpati1.jpg", hint: "ganesha idol", description: "A spectacular festival celebrating the birth of Lord Ganesha, the god of new beginnings and wisdom.", link: "/festivals/ganesh-chaturthi" },
    { name: "Christmas", region: "Nationwide", image: "https://i.postimg.cc/3dRK3ZY1/christmas-2.jpg", hint: "christmas tree", description: "Celebrating the birth of Jesus Christ, marked by carols, feasts, and the spirit of giving.", link: "/festivals/christmas" },
    ...
    { name: "Onam", region: "South", image: "https://i.postimg.cc/1VzZ59hX/Onam.png", hint: "flower carpet", description: "Kerala's most important harvest festival, celebrating the homecoming of the mythical King Mahabali.", link: "/festivals/onam" },
    ...
    { name: "Raksha Bandhan", region: "Nationwide", image: "https://i.postimg.cc/QBLskG5Y/raksha-bandhan.jpg", hint: "sacred thread", description: "A festival that celebrates the cherished bond between brothers and sisters, marked by the tying of a sacred thread.", link: "/festivals/raksha-bandhan" },
