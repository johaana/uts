    ...
    return (
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-primary/10">
                 <Image src="https://i.postimg.cc/tTV41DPm/ganpati1.jpg" alt="Ganesh Idol" layout="fill" objectFit="cover" className="absolute opacity-20" data-ai-hint="ganesha idol" />
