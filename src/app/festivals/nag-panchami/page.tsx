    ...
    return (
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-gray-500/10">
                 <Image src="https://i.postimg.cc/T1gD4R6R/nag-panchami1.jpg" alt="Serpent deity" layout="fill" objectFit="cover" className="absolute opacity-20" data-ai-hint="snake worship"/>
                        ...
                        <Tabs defaultValue="overview">
                            ...
                            <TabsContent value="overview">
                                ...
                                <div className="space-y-4 text-foreground/80 prose max-w-none">
                                    <p>Nag Panchami is a unique and ancient festival dedicated to the worship of serpents, or 'Nagas'. Observed on the fifth day of the bright half of the lunar month of Shravana, this festival holds deep cultural and ecological significance. In Hinduism, serpents are revered as sacred beings, associated with major deities like Lord Shiva, who wears the serpent Vasuki around his neck, and Lord Vishnu, who rests on the great serpent Shesha. They are seen not as fearsome creatures but as symbols of power, rebirth, and cosmic energy.</p>
                                    <p>The festival's origins are linked to several legends, the most famous being the story of the serpent king Takshaka, who was cursed to die in a fire sacrifice (sarpa yagna) initiated by King Janamejaya. The sage Astika intervened and saved Takshaka and the serpent race. Nag Panchami is celebrated to honor this event and to seek protection from snake bites, which are a real danger in rural India during the monsoon season. It is a day to acknowledge the role of serpents in nature and to live in harmony with all creatures.</p>
                                </div>
                            </TabsContent>
