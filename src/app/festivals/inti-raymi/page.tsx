...
export const metadata = {
  title: "Inti Raymi: Know before you plan.",
  description: "Inti Raymi is observed in Peru on Jun 24, 2026. A holiday for one traveler is a closed office for another. Know which one you are. Same date. Different plans. Different consequences.",
};
