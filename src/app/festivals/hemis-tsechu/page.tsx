        ...
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-primary/10">
                <div className="relative text-center text-primary-foreground">
                    <h1 className="font-headline text-5xl md:text-7xl font-bold text-primary shadow-lg">Hemis Tsechu</h1>
                    <p className="text-xl md:text-2xl mt-4 text-primary/90 shadow-md">The Masked Dances of Ladakh</p>
                </div>
            </section>
            ...
            <div className="container mx-auto px-4 py-12 -mt-24">
                <Card className="mb-12">
                    <CardContent className="p-6 md:p-10">
                        ...
                        <ShareButtons title="Hemis Tsechu" />
                    </CardContent>
                </Card>
            </div>
        </div>
