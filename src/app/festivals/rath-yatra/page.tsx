...
const recipes = [
    { name: "Khechudi", image: "https://placehold.co/400x300.png", hint: "rice and lentil dish" },
    { name: "Dalma", image: "https://placehold.co/400x300.png", hint: "lentil and vegetable stew" },
    { name: "Mahaprasad", image: "https://placehold.co/400x300.png", hint: "temple food" },
]
                        ...
                        <Tabs defaultValue="overview">
                            ...
                            <TabsContent value="overview">
                                ...
                                <div className="space-y-4 text-foreground/80 prose max-w-none">
                                    <p>Rath Yatra, the Festival of Chariots, is a grand celebration centered around Lord Jagannath and his siblings, Lord Balabhadra and Subhadra. The festival commemorates their annual journey from the Jagannath Temple in Puri to the Gundicha Temple, believed to be their aunt's home.</p>
                                    <p>Millions of devotees flock to Puri to witness the spectacular procession, where the deities are carried in massive, elaborately decorated chariots, pulled by the devotees themselves. It's a powerful expression of devotion and community service.</p>
                                </div>
                            </TabsContent>
