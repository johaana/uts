        ...
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-blue-800/10">
                ...
                <div className="relative text-center text-primary-foreground z-10">
                    <h1 className="font-headline text-5xl md:text-7xl font-bold text-white shadow-lg">Republic Day</h1>
                    <p className="text-xl md:text-2xl mt-4 text-white/90 shadow-md">Celebrating the Constitution of India</p>
                </div>
            </section>
