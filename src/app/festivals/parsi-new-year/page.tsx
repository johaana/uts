                                ...
                                <div className="space-y-4 text-foreground/80 prose max-w-none">
                                     <div className="flex flex-col md:flex-row gap-8 items-center">
                                        ...
                                        <div className="md:w-1/3">
                                            <Image src="https://i.postimg.cc/d3p6FFnw/pateti-parsi-new-year.jpg" alt="Pateti Prayers" width={400} height={400} className="rounded-lg shadow-lg w-full" data-ai-hint="parsi prayer"/>
                                            <p className="text-center text-sm text-muted-foreground mt-2">Parsis offer prayers on Pateti, the day of repentance.</p>
                                        </div>
                                    </div>
                                </div>
                            </TabsContent>
