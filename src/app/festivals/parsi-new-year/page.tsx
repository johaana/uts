                        ...
                        <Tabs defaultValue="overview">
                            ...
                            <TabsContent value="recipes">
                                <h2 className="font-headline text-3xl font-bold mb-4">Festive Foods</h2>
                                 <p className="mb-6 text-foreground/80 prose max-w-none">Parsi cuisine is a rich blend of Persian and Gujarati flavors. While we have removed the specific recipes for now, classic dishes include Sali Boti and Patra ni Machchi.</p>
