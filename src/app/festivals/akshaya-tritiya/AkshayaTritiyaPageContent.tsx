    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-6 text-foreground/80 prose max-w-none">Foods prepared on Akshaya Tritiya are typically simple, sattvic (pure), and often yellow or white in color, symbolizing prosperity and purity. Sweet Pongal and Payasam are popular choices.</p>
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                   <Link href="/recipes/sakkarai-pongal">
                        <Card className="overflow-hidden h-full hover:shadow-xl transition-shadow duration-300">
                            <CardContent className="p-4">
                                <h3 className="font-headline text-xl font-bold text-center text-primary h-14 flex items-center justify-center">Sweet Pongal</h3>
                            </CardContent>
                        </Card>
                    </Link>
                    <Link href="/recipes/payasam">
                        <Card className="overflow-hidden h-full hover:shadow-xl transition-shadow duration-300">
                            <CardContent className="p-4">
                                <h3 className="font-headline text-xl font-bold text-center text-primary h-14 flex items-center justify-center">Payasam</h3>
                            </CardContent>
                        </Card>
                    </Link>
                </div>
...
export function AkshayaTritiyaPageContent({ isContent = false }: { isContent?: boolean }) {
