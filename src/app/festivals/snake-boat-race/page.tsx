    ...
    return (
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-blue-600/10">
                 <Image src="https://i.postimg.cc/F15zG8Mx/snake-Boat-Race-Kerala.webp" alt="Snake Boat Race" layout="fill" objectFit="cover" className="absolute inset-0 z-0 opacity-20" data-ai-hint="kerala boat race" />
