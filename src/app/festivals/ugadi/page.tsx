    ...
    return (
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-primary/10">
                 <Image src="https://i.postimg.cc/t4Qzcs5k/gudi-padwa1.webp" alt="Ugadi" layout="fill" objectFit="cover" className="absolute opacity-20" data-ai-hint="new year festival"/>
                <div className="relative text-center text-primary-foreground">
                    <h1 className="font-headline text-5xl md:text-7xl font-bold text-white shadow-lg">Ugadi</h1>
                    <p className="text-xl md:text-2xl mt-4 text-white/90 shadow-md">The New Year of the Deccan</p>
                </div>
            </section>
