        ...
        <div className="bg-background">
             <div className="container mx-auto px-4 py-12">
                <Card className="mb-12 overflow-hidden">
                     <Image src="https://i.postimg.cc/Vvqmzy7S/ram-navami.webp" alt="Ram Navami" width={1200} height={400} className="w-full h-48 md:h-64 object-cover" data-ai-hint="lord rama" />
                    <div className="p-6 md:p-10 text-center">
                        <h1 className="font-headline text-4xl md:text-7xl font-bold text-primary">Ram Navami</h1>
                        <p className="text-xl md:text-2xl mt-2 text-muted-foreground">Celebrating the Birth of Lord Rama</p>
                    </div>
