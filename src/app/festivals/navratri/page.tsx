    ...
    return (
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-primary/10">
                 <Image src="https://i.postimg.cc/0Nffmbwk/sanin-sn-B4-ZQ2m-KEiq-Y-unsplash.jpg" alt="Garba dance" layout="fill" objectFit="cover" className="absolute opacity-20" data-ai-hint="garba dance"/>
                                   ...
                                   <div className="flex flex-col md:flex-row gap-6">
                                        <div className="md:w-1/2">
                                            <div className="relative w-full h-64 bg-muted rounded-lg shadow-md">
                                                <Image src="https://i.postimg.cc/0Nffmbwk/sanin-sn-B4-ZQ2m-KEiq-Y-unsplash.jpg" alt="Garba Dance" layout="fill" objectFit="cover" className="rounded-lg" data-ai-hint="garba dance"/>
                                            </div>
                                        </div>
                                        <div className="md:w-1/2">
