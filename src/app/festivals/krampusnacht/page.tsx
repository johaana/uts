...
const relatedContent: RelatedItem[] = [
    ...
    },
    {
        slug: "halloween",
        title: "Halloween",
        image: "https://i.postimg.cc/T2pSDM6G/halloween.jpg",
        type: "Festival",
        link: "/festivals/halloween",
        hint: "jack-o-lantern"
    },
    {
        slug: "st-patricks-day",
        title: "St. Patrick's Day",
        image: "https://i.postimg.cc/1XTmKpWH/St-Patrick-s-Day-Ireland-Global.avif",
        type: "Festival",
        link: "/festivals/st-patricks-day",
        hint: "irish parade"
    }
];
                    ...
                    <CardContent className="p-6 md:p-10">
                        <div className="grid md:grid-cols-12 gap-8 lg:gap-12">
                            <main className="md:col-span-12">
                               ...
                               <ShareButtons title="Krampusnacht: The Night of the Christmas Demon" />
