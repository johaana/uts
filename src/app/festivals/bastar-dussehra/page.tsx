    ...
    return (
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-primary/10">
                 <Image src="https://i.postimg.cc/rmVJnj2w/Pushkar-Camel-Fair.avif" alt="Bastar Dussehra" layout="fill" objectFit="cover" className="absolute opacity-20" data-ai-hint="tribal festival india"/>
