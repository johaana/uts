...
const recipes = [
    { name: "Ghevar", link: "/recipes/ghevar" }
];
        ...
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center bg-green-500/10">
                <div className="relative text-center text-primary-foreground z-10 p-4">
                    <h1 className="font-headline text-4xl md:text-5xl lg:text-7xl font-bold text-green-900 drop-shadow-lg">Teej</h1>
                    <p className="text-lg md:text-xl lg:text-2xl mt-4 text-green-800/90 drop-shadow-md">The Monsoon Festival of Swings</p>
                </div>
            </section>
                    ...
                    <CardContent className="p-6 md:p-10">
                        <Tabs defaultValue="overview">
                            ...
                            <TabsContent value="recipes">
                                <h2 className="font-headline text-3xl font-bold mb-4">Teej Delicacies</h2>
