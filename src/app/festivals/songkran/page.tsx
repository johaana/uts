...
export const metadata = {
  title: "Songkran: Know before you plan.",
  description: "Songkran is observed in Thailand on Apr 13, 2026. A holiday for one traveler is a closed office for another. Know which one you are. Same date. Different plans. Different consequences.",
};
