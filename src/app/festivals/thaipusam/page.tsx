                        ...
                        <Tabs defaultValue="overview">
                            ...
                            <TabsContent value="overview">
                                ...
                                <div className="space-y-4 text-foreground/80 prose max-w-none">
                                    <p>Thaipusam is a powerful and visually striking Hindu festival celebrated by the Tamil community, primarily in Tamil Nadu, Sri Lanka, Malaysia, and Singapore. It is a day of intense devotion dedicated to Lord Murugan, the Hindu god of war, victory, and wisdom, and the son of Lord Shiva. The festival commemorates the event when his mother, the goddess Parvati, gave him a divine spear, or 'Vel', so he could vanquish the evil demon Soorapadman.</p>
                                    <p>The festival is observed in the Tamil month of 'Thai' on the full moon day. It is a time for devotees to make good on vows, offer thanks, and pray for blessings. The central theme of Thaipusam is the triumph of good over evil and the power of faith. Devotees prepare for the festival by cleansing themselves through prayer and fasting for several weeks before the main day.</p>
                                </div>
                            </TabsContent>
