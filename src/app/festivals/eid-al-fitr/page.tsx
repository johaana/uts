    ...
    return (
        <div className="bg-background">
            <section className="relative h-[50vh] flex items-center justify-center">
                <Image src="https://images.unsplash.com/photo-1588062803975-7c9181244955?q=80&w=1600&h=800&fit=crop" alt="Eid celebration" layout="fill" objectFit="cover" className="opacity-20" data-ai-hint="eid prayers mosque"/>
