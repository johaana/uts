...
const recipes = [
    { name: "Gujiya", image: "https://placehold.co/400x300.png", hint: "sweet dumpling" },
    { name: "Thandai", image: "https://placehold.co/400x300.png", hint: "cold drink" },
    { name: "Dahi Bhalla", image: "https://placehold.co/400x300.png", hint: "lentil fritter" },
]
                        ...
                        <Tabs defaultValue="overview">
                            ...
                            <TabsContent value="overview">
                                ...
                                <div className="space-y-4 text-foreground/80 prose max-w-none">
                                    <p>Holi is a vibrant festival that celebrates the victory of good over evil, the arrival of spring, and the spirit of love and forgiveness. The festival has its roots in the legend of Prahlad, a devout follower of Lord Vishnu, who was saved from a bonfire by his divine grace, while his evil aunt Holika perished.</p>
                                    <p>The night before Holi, a bonfire called Holika Dahan is lit, symbolizing the burning of evil. The next day, people joyfully throw colored powders and water at each other, forgetting all resentments and inhibitions.</p>
                                </div>
                            </TabsContent>
