  ...
  return (
    <div className="flex flex-col">
       <section className="relative w-full">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center md:items-start md:justify-end md:text-left p-4 md:p-6 lg:p-24 pb-24 md:pb-24 lg:pb-24">
