  ...
  return (
    <div className="flex flex-col">
       <section className="relative w-full">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center lg:items-start lg:text-left p-4 lg:px-24">
          ...
          <p className="mt-4 text-md md:text-xl text-white/90 drop-shadow-[0_2px_2px_rgba(0,0,0,0.7)] max-w-2xl">
