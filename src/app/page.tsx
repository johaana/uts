    ...
    <div className="flex flex-col">
       <section className="relative w-full">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-start justify-end text-left p-6 md:p-8 lg:p-12">
          <h1 className="font-headline text-4xl md:text-5xl lg:text-7xl font-bold text-white drop-shadow-[0_2px_2px_rgba(0,0,0,0.9)] max-w-4xl">Rediscover Your Roots, One Festival at a Time</h1>
